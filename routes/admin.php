...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module' ]], function () {
        ...
        // client-side
        Route::group(['prefix' => 'client-side', 'as' => 'client-side.'], function () {
            Route::get('add-new', 'ClientSideController@index')->name('add-new');
            Route::get('list', 'ClientSideController@list')->name('list');
            Route::post('client-side', 'ClientSideController@store')->name('store');
            Route::get('edit/{id}', 'ClientSideController@edit')->name('edit');
            Route::post('update/{id}', 'ClientSideController@update')->name('update');
            Route::delete('delete/{id}', 'ClientSideController@delete')->name('delete');
            Route::post('status/{id}', 'ClientSideController@status')->name('status');
            // CLIENT USERS
            Route::get('client-user', 'ClientSideController@listclient_user')->name('listclient_user');
            Route::post('client-store', 'ClientSideController@listclient_store')->name('listclient_store');
            Route::get('client-list-export', 'ClientSideController@exportList')->name('exportList');
        ...
        Route::group(['prefix' => 'segments', 'as' => 'segments.'], function () {
            ...
            Route::post('segments', 'SegmentsController@store')->name('store');
            Route::get('edit/{id}', 'SegmentsController@edit')->name('edit');
       ...
       // Client Users Segments
        ...
        Route::group(['prefix' => 'VoucherType', 'as' => 'VoucherType.'], function () {
            ...
            Route::post('update/{id}', 'VoucherTypeController@update')->name('update');
      ...
      // Management Types
       ...
       // Management Types
        ...
        Route::group(['prefix' => 'VoucherSetting', 'as' => 'VoucherSetting.'], function () {
            ...
            Route::get('conditions-get-all', 'VoucherSettingController@getAll')->name('conditions.getAll');
            Route::post('conditions-store', 'VoucherSettingController@conditions_store')->name('conditions.store');
            Route::post('conditions-delete', 'VoucherSettingController@conditions_delete')->name('conditions.delete');
       ...
       // Management Types
        ...
        Route::group(['prefix' => 'app', 'as' => 'app.'], function () {
            ...
            Route::post('segments', 'AppController@store')->name('store');
